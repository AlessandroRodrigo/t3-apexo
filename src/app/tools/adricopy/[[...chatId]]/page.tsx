...
export default function AdriCopyTool({
  params,
}: {
            ...
            <div className="flex w-full flex-1 flex-col">
              {messages.length === 0 && (
                <Card className="mx-4 mt-4">
                  <CardHeader>
                    <CardTitle>AdriCopy</CardTitle>
                    <CardDescription>
                      AdriCopy is a tool that helps you write better, more
                      persuasive copy. It&apos;s like having a copywriter in
                      your pocket!
                    </CardDescription>
                  </CardHeader>
                </Card>
